...
class Woocommerce_Order_Tags {
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-woocommerce-order-tags-public.php';
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Woocommerce_Order_Tags_Public( $this->get_plugin_name(), $this->get_version() );
